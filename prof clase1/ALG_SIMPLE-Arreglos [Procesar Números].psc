Algoritmo Nums_Pos_Y_Neg
	repetir
		mostrar "Ingrese la cantidad de números a generar"
		Leer cant_nums
	...
	FinPara
	// Contar y listar los números positivos
	...
	FinPara
	Mostrar ""
	Mostrar "Fueron generados " cont_positivos " números positivos" 
	Mostrar ""
	Mostrar "Listado de Negativos"
	// Contar y listar los números negativos
	cont_negativos=0
	Para i=1 hasta cant_nums	
		Si nums[i]<0 entonces
	...
	FinPara
	Mostrar ""
	Mostrar "Fueron generados " cont_negativos " números negativos" 
	cont_ceros=0
	Mostrar ""
	Mostrar "Los ceros están la(s) posición(es) "
	Para i=1 hasta cant_nums
		Si nums[i]=0 entonces
			Mostrar "Posición: " nums[i]
		FinSi
	FinPara
FinAlgoritmo
